...
fn main() {
    ...
    println!("Large input (100 + 98 digits): result length={}", result_vec.len());
    ...
    println!("Original - Operations per second: {:.0}", 1.0 / avg_time.as_secs_f64());
    ...
    println!("Optimized - Operations per second: {:.0}", 1.0 / avg_time.as_secs_f64());
    ...
    println!("Ultra Safe - Operations per second: {:.0}", 1.0 / avg_time.as_secs_f64());
    ...
    println!("Elegant - Operations per second: {:.0}", 1.0 / avg_time.as_secs_f64());
    ...
    println!("Functional - Operations per second: {:.0}", 1.0 / avg_time.as_secs_f64());
    ...
    unsafe {
        ...
        println!("Unsafe - Operations per second: {:.0}", 1.0 / avg_time.as_secs_f64());
